    ...
    (e = function () {
        ...
        return function (t, o) {
            ...
            n.defaults = {
                ...
                arrows: !0,
                asNavFor: null,
                prevArrow: '<button class="btn btn-primary left" aria-label="Previous" type="button"><i class="material-icons">keyboard_arrow_left</i>prev</button>',
                nextArrow: '<button class="btn btn-primary right" aria-label="Next" type="button"><i class="material-icons">keyboard_arrow_right</i>next</button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
